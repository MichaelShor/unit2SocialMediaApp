...
class MichaelViewController: UIViewController {
    ...
    var Person1 = person(name: "Bobby", birthday: "Jan 7 2005", age: 25, location: "New York", following: 1003, followers: 5000, numOfLikes: 5000000, pic: (UIImage(named: "chad") ?? UIImage(systemName: "square.and.arrow.up.circle"))!, hasPet: true)
